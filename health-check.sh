...
#archvie node only
screen -dSm node1 geth --datadir node1/ --syncmode 'full' --gcmode=archive  --port 30312 --rpc --rpcaddr 'localhost' --rpcport 8550 --rpcapi 'personal,eth,net,web3,txpool,miner' --networkid 999 --gasprice '1'

#validating node (don't use this option for unlocking !)
#screen -dSm node1 geth --datadir node1/ --syncmode 'full' --port 30312 --rpc --rpcaddr 'localhost' --rpccorsdomain "*" --rpcport 8550 --rpcapi 'personal,eth,net,web3,txpool,miner' --networkid 99 --gasprice '1' -unlock 'VALIDATING-ADDRESS-withouth-0x' --password passwort.txt --mine --allow-insecure-unlock
